      ...
      this.$nextTick(() => {
        ...
        if (this.dataForm.id) {
          this.$http({
            ...
            if (data && data.code === 0) {
              console.log("查询了病床");
              this.hospitalId = data.patient.hospitalId;
              this.loadHospitalBeds(this.hospitalId);
              this.$refs.addComHos.hospitalId = data.patient.hospitalId;
              this.dataForm.patientName = data.patient.patientName;
              this.dataForm.patientCardId = data.patient.patientCardId;
              this.dataForm.patientHealthId = data.patient.patientHealthId;
              this.dataForm.createTime = data.patient.createTime;
              this.dataForm.createUserId = data.patient.createUserId;
              this.dataForm.deviceId = data.patient.deviceId;
              this.dataForm.inTime = data.patient.inTime;
              this.dataForm.outTime = data.patient.outTime;
            }
          });
        } else {
          this.loadHospitalBeds(this.hospitalId);
        ...
        if (valid) {
          ...
          this.$http({
            ...
            data: this.$http.adornData({
              ...
              patientHealthId: this.dataForm.patientHealthId,
